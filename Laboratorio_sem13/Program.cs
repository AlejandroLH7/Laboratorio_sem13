    ...
    class Program
    {
            ...
            do
            {
                ...
                switch (opcion)
                {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        MostrarMensajeError("Opción no válida. Inténtelo de nuevo.");
                        break;
                }
        ...
        static void RealizarEncuesta(Cliente[] clientes, ref int totalClientes)
        {
            if (totalClientes < MAX_CLIENTES)
            {
                ...
                {
                    MostrarMensajeError("Respuesta no válida. Inténtelo de nuevo.");
                }
            }
            else
            {
                MostrarMensajeError("Se alcanzó el límite máximo de clientes.");
            }
        }
        ...
        static void EliminarDato(Cliente[] clientes, ref int totalClientes)
        {
            ...
            if (totalClientes > 0)
            {
                ...
                {
                    EliminarCliente(clientes, ref totalClientes, posicionEliminar);
                    MostrarDatosConIndice(clientes, totalClientes);
                }
                else
                {
                    MostrarMensajeError("Posición no válida. Inténtelo de nuevo.");
                }
            }
            else
            {
        ...
        static void EliminarCliente(Cliente[] clientes, ref int totalClientes, int posicionEliminar)
        {
        ...
        static void MostrarAgradecimiento()
        {
            Console.Clear();
            Console.WriteLine("===================================");
            Console.WriteLine("Nivel de Satisfacción");
